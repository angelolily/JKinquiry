    ...
    <div class="layui-card" >
        ...
        <div class="layui-card-body">
            <div style="padding-bottom: 10px;">
                <button class="layui-btn layuiadmin-btn-admin" data-type="add">添加状态</button>
            </div>
...
<from class="layui-form" lay-filter="from_user" id="from_user" style="display:none;padding: 20px;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="statue_name" lay-verify="required" placeholder="请输入用户名称" autocomplete="off" class="layui-input">
        </div>
    </div>
...
<script>
    ...
    var g_table =table.render({
        ...
        cols: [[
            ...
            ,{field: 'statue_id', title: '状态id'}
            ,{field: 'statue_name', title: '状态名称'}
            ...
            layer.open({
                ...
                ,yes: function(index, layero){
                    ...
                    form.on('submit(LAY-user-front-submit)', function(data){
                        ...
                        $.ajax({
                            type:'post',
                            url:'./Statue/addStatue',
                            data:{statue_val:field},
                            dataType:'json',
                            async : false,
                ...
                if(obj.data.statue_id!=1){
                    if(value=='<?php echo $op_pwd; ?>'){
                        ...
                        layer.confirm('确定删除对吗', function(index){
                            ...
                            $.ajax({
                                type:'post',
                                url:'./Statue/delStatue',
                                data:{statue_id:selectrow.statue_id},
                                dataType:'json',
                                async : false,
                                success:function (result) {
                                    if(result.code){
