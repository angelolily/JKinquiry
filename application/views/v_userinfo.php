...
<from class="layui-form" lay-filter="from_user" id="from_user" style="display:none;padding: 20px;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="user_phone" id="user_phone" lay-verify="required|phone" placeholder="登陆时使用,默认密码相同" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    var g_table =table.render({
        ...
        cols: [[
            ...
            ,{field: 'user_phone', title: '用户手机号',width:150}
            ,{field: 'user_group_name',align:'center', title: '所属业务组',width:100}
            ,{field: 'user_type', align:'center',title: '用户角色',templet: '#usertype-Tpl',width:150}
            ,{field: 'user_phone', title: '用户手机号',width:150}
            ,{field: 'user_mail', title: '用户邮箱',width:150}
            ,{field: 'user_cs', title: '登陆次数',width:150}
        ...
        ,add: function(){
            ...
            layer.open({
                ...
                ,yes: function(index, layero){
                    ...
                    var vs_phone=$("#user_phone").val();
                    var is_vaile=0;
                    //验证手机号是否重复
                    $.ajax({
                        type:'post',
                        url:'./UserInfo/isphonerepeat',
                        data:{user_phone:vs_phone},
                        dataType:'text',
                        async : false,
                        success:function (result) {
                            if(result==1){
                                layer.msg("手机号码重复请重新输入！", {icon: 5});
                                is_vaile=1;
                            }
                        }
